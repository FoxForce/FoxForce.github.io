...
function setHeaderAndFooter(){
    ...
    document.getElementById('footer').innerHTML='<div class="container"> <div class="row"><div class="col-md-4"> <p class="text"> <strong>Get to Know Us</strong></p> <p class="text"><a href="#acerca">Who we are</a></p> <p class="text"> Our History </p> <p class="text"> <a href="organization.html">Our team <a/></p> </div><div class="col-md-4"><center> <img class="img-responsive" width="25%" src="resources/footer_icon.png"><br> <img class="img-responsive" width="30%" src="resources/footer_text.png"><br> <p class="text"><a href="mailto:foxforce@cetys.edu.mx"> foxforce@cetys.edu.mx </a></p></center></div> <div class="col-md-4 text-align-right"> <p class="text"> <strong>Connect</strong></p> <p class="text"><a href="http://www.facebook.com/foxforcesae">facebook</a> </p> <p class="text"><a href="https://www.instagram.com/fox.force.aerodesign/">instagram</a></p><p class="text"> <a href="#donate"> Donate</a> </p> </div></div>';
