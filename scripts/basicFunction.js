...
function setHeaderAndFooter(){
    ...
    if(location.pathname.split('/').slice(-1) === 'index.html')
	      document.getElementById('header').innerHTML='<nav class="navbar"><center><a class="navbar-brand"  href="#"><img alt="Brand" src="resources/Fox_IconWhite.png" style="margin-left:2em;" width="70em" height="40em"></a><a href="#" id="menu"> <i class="fa fa-bars fa-3x menu"  aria-hidden="true"></i> </a> <ul id="menu-options" class=" navbar-nav"><li> <a href="index.html#acerca" class="text-menu"> About Us </a> </li><li> <a href="organization" class="text-menu"> Our team </a> </li> <li> <a href="#contacto" class="text-menu"> Contact </a> </li> <li> <a class="text-menu-donate" href="index.html#donar"> Donate </a> </li></ul></center></div></nav>';
    else
