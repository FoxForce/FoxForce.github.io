...
$(window).on('scroll', function() {
    ...
    var scroll_pos_test = document.getElementById('header-image').height;             // set to whatever you want it to be
...
function setHeaderAndFooter(){
    ...
    if(location.pathname.split('/').slice(-1) === 'index.html')
	      document.getElementById('header').innerHTML='<nav class="navbar navbar-default"><div class="navbar-header"><center><a class="navbar-brand"  href="#"><img alt="Brand" src="resources/Fox_IconWhite.png" style="margin-left:2em;" width="70em" height="40em"></a><a href="#" id="menu"> <i class="fa fa-bars fa-3x menu"  aria-hidden="true"></i> </a><ul id="menu-options" class="nav navbar-nav"><li> <a href="#acerca"> <big>S</big>obre <big>n</big>osotros </a> </li><li> <a href="#contacto"> <big>C</big>ontáctanos </a> </li><li> <a href="#donar"> <big>D</big>onar </a> </li></ul></center></div></nav>';
    else
