...
function setHeaderAndFooter(){
	      ...
	      document.getElementById('header').innerHTML='<nav class="navbar"><center><a class="navbar-brand"  href="index.html"><img alt="Brand" src="resources/Fox_IconWhite.png" style="margin-left:2em;" width="70em" height="40em"></a><a href="#" id="menu"> <i class="fa fa-bars fa-3x menu"  aria-hidden="true"></i> </a> <ul id="menu-options" class=" navbar-nav"><li> <a href="index.html#acerca" class="text-menu"> About Us </a> </li><li> <a href="organization.html" class="text-menu"> Our team </a> </li> <li> <a href="index.html#contacto" class="text-menu"> Contact </a> </li> <li> <a class="text-menu-donate" href="index.html#donar"> Donate </a> </li></ul></center></div></nav>';
